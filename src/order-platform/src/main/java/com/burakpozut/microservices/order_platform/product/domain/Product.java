...
public class Product {
    ...
    private Product(
        ...
        if (id == null) throw new DomainValidationException(
            "Product Id can not be null"
        );
        if (name == null) throw new DomainValidationException(
            "Product name can not be null"
        );
        if (price == null) throw new DomainValidationException(
            "Price can not be null"
        );
        if (
            price.compareTo(BigDecimal.ZERO) <= 0
        ) throw new DomainValidationException("Price must be greater than 0");
        if (currency == null) throw new DomainValidationException(
            "Currency can not be null"
        );
        if (status == null) throw new DomainValidationException(
